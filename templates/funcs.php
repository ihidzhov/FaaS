...
<p>
  <a href="index.php?page=func" class="text-decoration-none">
      ...
      <tbody>
        <?php foreach($data as $value) { ?>
          <tr>
            ...
            <td>
              <a href="index.php?page=func&id=<?php echo $value["id"]; ?>">
                <?php echo $value["name"]; ?>
              </a>
            </td>
            ...
            <td class="text-center">
              <a href="index.php?page=func&id=<?php echo $value["id"]; ?>" title="Edit">
